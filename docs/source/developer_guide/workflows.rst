...
.. code:: console
   ...
   poetry add "package>=1.0"
   poetry add tessif_examples@latest
   poetry add git+https://github.com/tZ3ma/tessif_examples.git
   poetry add git+https://github.com/tZ3ma/tessif_examples.git#develop

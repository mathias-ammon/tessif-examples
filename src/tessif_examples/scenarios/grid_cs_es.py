# src/tessif_examples/scenarios/grid_cs_es.py
...
def create_grid_cs_es(periods=24, transformer_efficiency=0.99, directory=None, filename=None):
    """
    ...
    .. image:: ../../_static/system_model_graphs/grid_es_CS_example.png
        :align: center

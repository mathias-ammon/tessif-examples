# src/tessif_examples/scenarios/grid_tp_es.py
...
def create_grid_tp_es(periods=24, transformer_efficiency=0.99, gridcapacity=60000, directory=None, filename=None):
    """
    ...
    .. image:: ../../_static/system_model_graphs/grid_es_TP_example.png
        :align: center
    ...
    low_electricity_line = components.Bus(
        ...
        inputs=('BHKW.low-voltage-electricity', 'Power Source LV.low-voltage-electricity',
                'Solar Panel.low-voltage-electricity', 'Medium Low Transformator.low-voltage-electricity'),
        outputs=('Household Demand.low-voltage-electricity', 'Commercial Demand.low-voltage-electricity',
                 'Low Medium Transformator.low-voltage-electricity', 'Power Sink LV.low-voltage-electricity',),
        # Minimum number of arguments required
        latitude=42,
        longitude=42,
        region='Here',
    ...
    medium_electricity_line = components.Bus(
        ...
        inputs=('Onshore Wind Power.medium-voltage-electricity', 'High Medium Transformator.medium-voltage-electricity',
                'Low Medium Transformator.medium-voltage-electricity', 'Power Source MV.medium-voltage-electricity',),
        outputs=('Car charging Station.medium-voltage-electricity', 'Industrial Demand.medium-voltage-electricity',
                 'Power to Heat.medium-voltage-electricity', 'Medium High Transformator.medium-voltage-electricity',
                 'Medium Low Transformator.medium-voltage-electricity', 'Power Sink MV.medium-voltage-electricity',),
        # Minimum number of arguments required
        latitude=42,
        longitude=42,
        region='Here',
    ...
    high_electricity_line = components.Bus(
        ...
        inputs=('Offshore Wind Power.high-voltage-electricity', 'HKW2.high-voltage-electricity',
                'GuD.high-voltage-electricity', 'HKW.high-voltage-electricity',
                'Medium High Transformator.high-voltage-electricity', 'Power Source HV.high-voltage-electricity',),
        outputs=('Pumped Storage.high-voltage-electricity', 'High Medium Transformator.high-voltage-electricity',
    ...
    low_medium_transformator = components.Transformer(
        ...
        flow_rates={
            ...
            'medium-voltage-electricity': nts.MinMax(min=0, max=transformer_efficiency * gridcapacity)},
        flow_costs={'low-voltage-electricity': 0,
    ...
    medium_low_transformator = components.Transformer(
        ...
        node_type='connector',
        flow_rates={
            'low-voltage-electricity': nts.MinMax(min=0, max=transformer_efficiency * gridcapacity),
    ...
    medium_high_transformator = components.Transformer(
        ...
        node_type='connector',
        flow_rates={
            'high-voltage-electricity': nts.MinMax(min=0, max=transformer_efficiency * gridcapacity),
            'medium-voltage-electricity': nts.MinMax(min=0, max=gridcapacity)},
    ...
    es = energy_system.AbstractEnergySystem(
        ...
        sinks=(household_demand, commercial_demand, heat_demand, industrial_demand, car_charging_station_demand,
               power_sink_lv, power_sink_mv, power_sink_hv,),
        sources=(solar_panel, offshore_wind_power, onshore_wind_power, gas_supply, coal_supply, solar_thermal,
                 biogas_supply, power_source_lv, power_source_mv, power_source_hv,),
        transformers=(bhkw_generator, power_to_heat, gud_generator, hkw_generator, high_medium_transformator,
                      low_medium_transformator, medium_low_transformator, medium_high_transformator, hkw_generator_2),
        timeframe=timeframe,

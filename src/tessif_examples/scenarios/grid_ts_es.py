...
def create_grid_ts_es(periods=24, transformer_efficiency=0.99, gridcapacity=60000, directory=None, filename=None):
    """
    ...
    low_electricity_line = components.Bus(
        ...
        inputs=('BHKW.low-voltage-electricity', 'Solar Panel.low-voltage-electricity',
    ...
    medium_electricity_line = components.Bus(
        ...
        inputs=('Onshore Wind Power.medium-voltage-electricity', 'High Medium Transformator.medium-voltage-electricity',
                'Low Medium Transformator.medium-voltage-electricity', 'Pumped Storage MV.medium-voltage-electricity'),
        outputs=('Car charging Station.medium-voltage-electricity', 'Industrial Demand.medium-voltage-electricity',
                 ...
                 'Medium Low Transformator.medium-voltage-electricity', 'Pumped Storage MV.medium-voltage-electricity'),
        # Minimum number of arguments required
        latitude=42,
        longitude=42,
        region='Here',
    ...
    high_electricity_line = components.Bus(
        ...
        inputs=('Offshore Wind Power.high-voltage-electricity', 'HKW2.high-voltage-electricity',
                ...
                'Medium High Transformator.high-voltage-electricity', 'Pumped Storage HV.high-voltage-electricity'),

# src/tessif_examples/scenarios/grid_cp_es.py
...
def create_grid_cp_es(periods=24, transformer_efficiency=0.99, directory=None, filename=None):
    """
    ...
    .. image:: ../../_static/system_model_graphs/grid_es_CP_example.png
        :align: center
    ...
    low_medium_transformator = components.Connector(
        ...
        conversions={('Medium Voltage Powerline', 'Low Voltage Powerline'): transformer_efficiency,
                     ('Low Voltage Powerline', 'Medium Voltage Powerline'): transformer_efficiency},
    ...
    high_electricity_line = components.Bus(
        ...
        inputs=('Offshore Wind Power.electricity', 'Pumped Storage.electricity', 'GuD.electricity', 'HKW.electricity',
                'Power Source.electricity', 'HKW2.electricity'),
    ...
    high_medium_transformator = components.Connector(
        ...
        conversions={('Medium Voltage Powerline', 'High Voltage Powerline'): transformer_efficiency,
                     ('High Voltage Powerline', 'Medium Voltage Powerline'): transformer_efficiency},

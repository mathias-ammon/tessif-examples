...
mapping = {
    "sources": {
        "s1": {
            ...
            "component": "source",
            "node_type": "source",
            "accumulated_amounts": {"electricity": nts.MinMax(min=0, max=80)},
            ...
            "expansion_costs": {"electricity": 50},
            "expansion_limits": {"electricity": nts.MinMax(min=0, max=20)},
            "timeseries": None,
        },
        "s2": {
            "name": "source_2",
            ...
            "component": "source",
            "node_type": "source",
            "accumulated_amounts": {"electricity": nts.MinMax(min=0, max=60)},
            "flow_rates": {"electricity": nts.MinMax(min=0, max=10)},
            "flow_costs": {"electricity": 1},
            "flow_gradients": {
                "electricity": nts.PositiveNegative(positive=100, negative=100)
